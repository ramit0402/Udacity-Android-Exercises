...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    private final ListItemClickListner mOnItemClickListner;
     ...
     */
    public GreenAdapter(int numberOfItems, ListItemClickListner listItemClickListner) {
        mNumberItems = numberOfItems;
        mOnItemClickListner = listItemClickListner;
        viewHolderCount = 0;
    }
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            mOnItemClickListner.onListItemClick(clickedPosition);
        }
    }
}
